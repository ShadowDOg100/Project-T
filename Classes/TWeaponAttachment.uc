 ...
 * to the Mesh.
 */
simulated function AttachTo(TPawn OwnerPawn)
{
...
simulated function PlayImpactEffects(vector HitLocation)
{
	...
	if ( (P != None) && EffectIsRelevant(HitLocation, false, MaxImpactEffectDistance) )
	{
		...
		{
			UTVehicle(V).ApplyMorphDamage(HitLocation, WeaponClass.Default.InstantHitDamage[TPawn(Owner).FiringMode], WeaponClass.Default.InstantHitMomentum[TPawn(Owner).FiringMode]*FireDir);
		}
...
simulated function SetWeaponOverlayFlags(TPawn OwnerPawn)
{
