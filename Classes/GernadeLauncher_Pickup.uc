class GernadeLauncher_Pickup extends TPickup
    placeable;
...
event Touch(Actor Other, PrimitiveComponent OtherComp, vector HitLocation, vector HitNormal)
{
    if (Pawn(Other) != none)
    {
	    ...
	    bTouch = true;
		(TGFxHudWrapper(PC.myHUD)).SetTouch(bTouch, class'TGame.TWeap_SpecialWeapon_GernadeLauncher', Self);
...
DefaultProperties
{
	...
	Begin Object Class=SkeletalMeshComponent Name=PickupMesh
		SkeletalMesh=SkeletalMesh'MyWeapons.SK_WP_GernadeLauncher'
